...
public class AliyunSms {
	...
	//String aliyunSmsAppkey="LTAIgDJerZxD8twJ";
   // String aliyunSmsAppsecret="9PuLZNoEQRPDJm465MxL1JIXQY9Msh";
    @Value("${myPugin.aliyunSmsAppkey}")
    String aliyunSmsAppkey;
    @Value("${myPugin.aliyunSmsAppsecret}")
    String aliyunSmsAppsecret;
    //用户注册
  	@Value("${myPugin.aliyunSmsTemplateCodeAcountRegister}")
  	String aliyunSmsTemplateCodeAcountRegister;
  	//修改密码
  	@Value("${myPugin.aliyunSmsTemplateCodePasswordUpdate}")
  	String aliyunSmsTemplateCodePasswordUpdate;
  	//
  	@Value("${myPugin.aliyunSmsSignName}")
    ...
    public  SendSmsResponse sendSms(String extend,String recNum,Integer stc) throws ClientException {
    	...
    	String smsTemplatecode=aliyunSmsTemplateCodeAcountRegister;
    	if(stc==1){
    		smsTemplatecode=aliyunSmsTemplateCodeAcountRegister;
    		//smsTemplatecode="SMS_89885231";
    	}else if(stc==2){
    		smsTemplatecode=aliyunSmsTemplateCodePasswordUpdate;
        ...
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", aliyunSmsAppkey, aliyunSmsAppsecret);
