...
public interface DailyDataService {
	...
	/** 分页每日数据信息 */
	public List<DailyData> browsePagingDailyData(Date createDate,Integer goodsId,Integer acountId,int pageNum,int pageSize,String orderName,String orderWay) ;
	/** 统计每日数据信息 */
	public List<DailyData> statisticsDailyData(Date createDate,Date endDate,Integer goodsId,Integer acountId,int pageNum,int pageSize,String orderName,String orderWay) ;		
}
